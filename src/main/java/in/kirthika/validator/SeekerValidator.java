...
public class SeekerValidator {
	...
	public static boolean seekerNumberValidator(Long number, String name, String errorMessage)throws NotRegisteredException, ClassNotFoundException, SQLException {
